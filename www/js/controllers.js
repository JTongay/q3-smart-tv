...
.controller('AppCtrl', ['$scope', '$ionicModal', '$timeout', '$state', '$http', function($scope, $ionicModal, $timeout, $state, $http) {
  ...
  $scope.doSignup = function() {
    ...
    $http.post('/api/users/new', $scope.user).then(function(login){
      console.log('booyah');
